...
if (isset($_POST['title'])) {
    ...
    flash("post_added_admin", "Post has been added successfully");
...
<!-- -----------Main Contents----------- -->
<?php echo flash("post_added_admin"); ?>
        ...
        <div class="row m-0 p-0">
            <div class="col-lg-12 mt-4 ">
                <div class="panel-card">
                    <form action="" class="upload-post-form" method="post">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="w-100">
                                    <p class="f-20 w-400 my-2">Upload </p>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="w-100">
                                    <div class="mb-3">
                                        <label for="" class="form-label f-14 w-500">Title</label>
                                        <input type="text" name="title" class="form-control" id="title">
                                    </div>
                                </div>
                                <div class="w-100">
                                    <div class="mb-3">
                                        <label for="" class="form-label f-14 w-500">Tags</label>
                            ...
                            <div class="col-lg-6 d-flex flex-column justify-content-center  ">
                                ...
                                <div class="d-flex justify-content-center mt-5">
                                    <button id="submitBtn" type="button" class="panel-button2">Save</button>
                                </div>
