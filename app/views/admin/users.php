...
<main class="content pb-4">
    ...
    <div class="container-fluid">
        <?php echo flash("delete_user"); ?>
        <?php echo flash("restore_user"); ?>
        <div class="row m-0 -0">
                                ...
                                <?php if (!empty($users)) : ?>
                                    <?php foreach ($users as $user) : ?>
                                        <tr>
                                            ...
                                            <td class="icons">
                                                <div class="d-flex">
                                                    <a href="<?php echo URLROOT; ?>/admin/edit/<?php echo $user->id; ?>"> <i class="bi bi-pencil-square"></i></a>
                                                    <a href="<?php echo URLROOT; ?>/admin/delete/<?php echo $user->id; ?>"> <i class="bi bi-trash3-fill"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
