...
<main>
    <div class="container py-4">
        <div class="col-lg-12 ">
            <h1 class="f-26 w-700 text-primary text-center">TERMS AND CONDITIONS</h1>
            <p class="f-14 w-400 mt-4 ">Last updated: 2023-06-21</p>
            ...
            <p class="f-14 w-400 text-justify">
                Welcome to <b>Kwepilecorp</b> (“Company”, “we”, “our”, “us”)!<br><br>
                These Terms of Service (“Terms”, “Terms of Service”) govern your use of
                our website located at <b>Inscripchat.com</b> (together or individually
                “Service”) operated by <b>Kwepilecorp</b>.<br><br>
                ...
                of our web pages.<br><br>
                Your agreement with us includes these Terms and our Privacy Policy
                (“Agreements”). You acknowledge that you have read and understood
                Agreements, and agree to be bound of them.<br><br>
                ...
                <b> info@Inscripchat.com</b> so we can try to find a solution. These Terms
                apply to all visitors, users and others who wish to access or use Service.
            </p>


            <h3 class="f-18 w-700 mt-5 mb-3">2. Communications
            </h3>
            ...
            <p class="f-14 w-400 text-justify">
                ...
                info@Inscripchat.com.
            </p>

            <h3 class="f-18 w-700 mt-5 mb-3">3. Contests, Sweepstakes and Promotions
            ...
            <h3 class="f-18 w-700 mt-5 mb-3 ">4. Content
            ...
            <p class="f-14 w-400 text-justify">
                ...
                Service, including its legality, reliability, and appropriateness.<br><br>
                By posting Content on or through Service, You represent and warrant
                that: (i) Content is yours (you own it) and/or you have the right to use it
                ...
                rights or any other rights of any person or entity. We reserve the right to
                terminate the account of anyone found to be infringing on a copyright.<br><br>
                ...
                the right for us to make your Content available to other users of Service,
                who may also use your Content subject to these Terms.<br><br>
            </p>
            <p class="f-14 w-400">
                Some of the content that are accessible in this site which are retrieved
                from https://ocw.mit.edu/ do not belong to Kwepilecorp, the contents
                under the following License:<span class="f-12"> https://creativecommons.org/licenses/bync-sa/4.0/</span> can be freely
                downloaded, transformed, remixed and
                redistributed and Kwepilecorp does not own any of the material found on
                the site under the License mentioned above.
            </p><br><br>
            <p class="f-14 w-400 text-justify"> Kwepilecorp has the right but not the obligation to monitor and edit all
                Content provided by users.<br><br>
                In addition, Content found on or through this Service are the property of
                Kwepilecorp or used with permission. You may not distribute, modify,
                transmit, reuse, download, repost, copy, or use said Content, whether in
                whole or in part, for commercial purposes.
            </p>


            <h3 class="f-18 w-700 mt-5 mb-3">5. Prohibited Uses

            </h3>

            <p class="f-14 w-400 text-justify">
                You may use Service only for lawful purposes and in accordance with
                Terms. You agree not to use Service:<br><br>
                ...
                or any other similar solicitation.<br><br>
                0.4. To impersonate or attempt to impersonate Company, a Company
                employee, another user, or any other person or entity.<br><br>
                ...
                unlawful, illegal, fraudulent, or harmful purpose or activity.<br><br>
                ...
                offend Company or users of Service or expose them to liability.<br><br>
                ...
                including their ability to engage in real time activities through Service.<br><br>
                ...
                working of Service.<br><br>
                0.5. Introduce any viruses, trojan horses, worms, logic bombs, or other
                material which is malicious or technologically harmful.<br><br>
                ...
                server, computer, or database connected to Service.<br><br>
            ...
            <h3 class="f-18 w-700 mt-5 mb-3">6. Analytics
            ...
            <h3 class="f-18 w-700 mt-5 mb-3">7. No Use By Minors
            ...
            <p class="f-14 w-400 text-justify">
                ...
                eighteen (18) years old, you are prohibited from both the access and
                usage of Service.
            </p>


            <h3 class="f-18 w-700 mt-5 mb-3">8. Accounts
            ...
            <p class="f-14 w-400 text-justify">
                ...
                Kwepilecorp and its licensors. Service is protected by copyright,
                ...
                written consent of Kwepilecorp.

            </p>


            <h3 class="f-18 w-700 mt-5 mb-3"> 10. Copyright Policy
            </h3>
            <p class="f-14 w-400 text-justify">
                ...
                info@Inscripchat.com, with the subject line: “Copyright Infringement”
                ...
                Copyright Infringement Claims”<br><br>
            ...
            <h3 class="f-18 w-700 mt-5 mb-3"> 11. DMCA Notice and Procedure for Copyright Infringement Claims
            ...
            <p class="f-14 w-400 text-justify">
                ...
                behalf of the owner of the copyright’s interest;<br><br>
                ...
                the material that you claim is infringing is located;<br><br>
                ...
                owner or authorized to act on the copyright owner’s behalf.<br><br>
                You can contact our Copyright Agent via email at info@Inscripchat.com.
            </p>
            ...
            <p class="f-14 w-400 text-justify">
                You may provide us either directly at info@Inscripchat.com or via third
                ...
                may have development ideas similar to the Feedback; (iii) Feedback does
            ...
            <p class="f-14 w-400 text-justify">
                ...
                are not owned or controlled by Kwepilecorp.<br><br>
                Kwepilecorp has no control over, and assumes no responsibility for the
                ...
                <a href="https://policymaker.io/">PolicyMaker.io</a>, a free web application for generating
                high-quality legal
            ...
            <p class="f-14 w-400 text-justify">
                ...
                ITEMS OBTAINED FROM US IS AT YOUR SOLE RISK.<br><br>
            ...
            <p class="f-14 w-400 text-justify">
                ...
                WITHOUT LIMITATION ANY CLAIM FOR PERSONAL INJURY OR
                PROPERTY DAMAGE, ARISING FROM THIS AGREEMENT AND ANY
                ...
                AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART
            ...
            <p class="f-14 w-400 text-justify">
                ...
                laws of South Africa, which governing law applies to agreement without
            ...
            <p class="f-14 w-400 text-justify">
                ...
                site. It is your responsibility to review these Terms periodically.<br><br>
            ...
            <p class="f-14 w-400 text-justify">
                ...
                email: <b>Termsinfo@Inscripchat.com.</b>
            </p>
