                        ...
                        <div class="col-lg-12 col-md-6 col-sm-8 mx-auto col-12">
                            <div>
                                <div class="main-img-sm w-100">
                                    <a href="chat.html" class="no-decoration">
                                        <img src="assets/images/8.jfif" alt="" class="w-100">
                                    </a>
                                    <div class="menu-icon">
                                        <div class="dropdown ">
                                ...
                                <div class="d-flex justify-content-between align-items-center px-1 mb-2 mt-2">
                                    <h2 class="f-14 w-500  ellipsis-1 pt-0 mt-0">Parabolas in Symmetry </h2>
                                    <h2 class="f-12 w-500 ellipsis-1  pb-0 pt-0 mt-0">306K Views</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-6 col-sm-8 mx-auto col-12">
                            <div class="doc-img-sm">
                                <a href="document.html" class="no-decoration">
                                    <img src="assets/images/adobe pdf 1.png" alt="" class="">
                                </a>
                                <div class="menu-icon">
                                    <div class="dropdown ">
                                        <button type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown"
                            ...
                            <div class="d-flex justify-content-between align-items-center px-1 mb-2 pt-1">
                                <h2 class="f-14 w-500 py-1 ellipsis-1">Parabolas in Symmetry </h2>
                                <h2 class="f-12 w-500 ellipsis-1">306K Views</h2>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-6 col-sm-8 mx-auto col-12">
                            <div>
                                <!-- <div class="main-video-div ">
                                    <video width="100%" class="main-video" id="video2">
                                        <source src="assets/images/video/Download the Best Free Nature Videos_2.mp4"
                                            type="video/mp4">
                                    </video>
                                    <div class="play-btn-div-search">
                                        <div class="play-btn-search">
                                        </div>
                                    </div>
                                    <div class="pause-btn-div-search">
                                        <div class="pause-btn-search">
                                        </div>
                                    </div>
                                </div> -->
                                <div class="main-img-sm w-100">
                                    <a href="chat.html" class="no-decoration">
                                        <img src="assets/images/9.jfif" alt="" class="w-100">
                                    </a>
                                    <div class="menu-icon">
                                        <div class="dropdown ">
                                            <button type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown"
                ...
                <div class="col-lg-8 mt-4 ms-auto order-first order-lg-last">
                        ...
                        <div class=" main-video-col">
                            <div class="main-img-full w-100">
                                <?php if($post->type === "image"): ?>
                                    <img src="<?php echo URLROOT; ?>/public/uploads/<?php echo $post->content; ?>" alt="" class="w-100">
                                <?php else: ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center px-1 flex-wrap">
                                ...
                                <div class="d-flex align-items-center">
                                    <h2 class="second-heading py-1 m-0 p-0 me-2"><?php echo formatViews($post->views); ?> Views</h2>
                                    <span>

                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                                            class="bi bi-hand-thumbs-up-fill thumb me-1" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <span>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                                            class="bi bi-hand-thumbs-down-fill thumb" viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="mt-3 ">
                        ...
                        <div class="d-flex align-items-center mt-3 w-100">
                            <div class="dp"><img src="assets/images/image 1.png" alt="" class="img-fluid"></div>
                            <div class="comment-input w-100 ms-2">
                                <!-- <input type="text" class="w-100" placeholder="Comment"> -->
                                <textarea name="" id="" width="100" rows="1" placeholder="Comment"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="comment-box mt-4 mb-4">
                            <div class="comment">
                                <div class="comment-dp">
                                    <img src="assets/images/image 1.png" alt="" class="">
                                </div>
                                    ...
                                    <div class="d-flex align-items-top justify-content-end">
                                        <span>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                fill="currentColor" class="bi bi-hand-thumbs-up-fill thumb me-2"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M6.956 1.745C7.021.81 7.908.087 8.864.325l.261.066c.463.116.874.456 1.012.965.22.816.533 2.511.062 4.51a9.84 9.84 0 0 1 .443-.051c.713-.065 1.669-.072 2.516.21.518.173.994.681 1.2 1.273.184.532.16 1.162-.234 1.733.058.119.103.242.138.363.077.27.113.567.113.856 0 .289-.036.586-.113.856-.039.135-.09.273-.16.404.169.387.107.819-.003 1.148a3.163 3.163 0 0 1-.488.901c.054.152.076.312.076.465 0 .305-.089.625-.253.912C13.1 15.522 12.437 16 11.5 16H8c-.605 0-1.07-.081-1.466-.218a4.82 4.82 0 0 1-.97-.484l-.048-.03c-.504-.307-.999-.609-2.068-.722C2.682 14.464 2 13.846 2 13V9c0-.85.685-1.432 1.357-1.615.849-.232 1.574-.787 2.132-1.41.56-.627.914-1.28 1.039-1.639.199-.575.356-1.539.428-2.59z" />
                                        ...
                                        <span>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                fill="currentColor" class="bi bi-hand-thumbs-down-fill thumb"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M6.956 14.534c.065.936.952 1.659 1.908 1.42l.261-.065a1.378 1.378 0 0 0 1.012-.965c.22-.816.533-2.512.062-4.51.136.02.285.037.443.051.713.065 1.669.071 2.516-.211.518-.173.994-.68 1.2-1.272a1.896 1.896 0 0 0-.234-1.734c.058-.118.103-.242.138-.362.077-.27.113-.568.113-.856 0-.29-.036-.586-.113-.857a2.094 2.094 0 0 0-.16-.403c.169-.387.107-.82-.003-1.149a3.162 3.162 0 0 0-.488-.9c.054-.153.076-.313.076-.465a1.86 1.86 0 0 0-.253-.912C13.1.757 12.437.28 11.5.28H8c-.605 0-1.07.08-1.466.217a4.823 4.823 0 0 0-.97.485l-.048.029c-.504.308-.999.61-2.068.723C2.682 1.815 2 2.434 2 3.279v4c0 .851.685 1.433 1.357 1.616.849.232 1.574.787 2.132 1.41.56.626.914 1.28 1.039 1.638.199.575.356 1.54.428 2.591z" />
                                        ...
                                        <button type="button"
                                            class="f-14 text-primary w-500 ms-4 reply-btn">Reply</button>
                                    </div>
                                    <div class="comment-input w-100  reply-input">
                                        <!-- <input type="text" class="w-100 bg-white " placeholder="Reply"> -->
                                        <textarea name="" class="bg-white" id="" width="100" rows="1"
                                            ...
                                            <div class="reply-text">
                                                ...
                                                <div class="d-flex align-items-top justify-content-end">
                                                    <span>
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                            fill="currentColor"
                                                            class="bi bi-hand-thumbs-up-fill thumb me-2"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                d="M6.956 1.745C7.021.81 7.908.087 8.864.325l.261.066c.463.116.874.456 1.012.965.22.816.533 2.511.062 4.51a9.84 9.84 0 0 1 .443-.051c.713-.065 1.669-.072 2.516.21.518.173.994.681 1.2 1.273.184.532.16 1.162-.234 1.733.058.119.103.242.138.363.077.27.113.567.113.856 0 .289-.036.586-.113.856-.039.135-.09.273-.16.404.169.387.107.819-.003 1.148a3.163 3.163 0 0 1-.488.901c.054.152.076.312.076.465 0 .305-.089.625-.253.912C13.1 15.522 12.437 16 11.5 16H8c-.605 0-1.07-.081-1.466-.218a4.82 4.82 0 0 1-.97-.484l-.048-.03c-.504-.307-.999-.609-2.068-.722C2.682 14.464 2 13.846 2 13V9c0-.85.685-1.432 1.357-1.615.849-.232 1.574-.787 2.132-1.41.56-.627.914-1.28 1.039-1.639.199-.575.356-1.539.428-2.59z" />
                                                    ...
                                                    <span>
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                            fill="currentColor"
                                                            class="bi bi-hand-thumbs-down-fill thumb"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                d="M6.956 14.534c.065.936.952 1.659 1.908 1.42l.261-.065a1.378 1.378 0 0 0 1.012-.965c.22-.816.533-2.512.062-4.51.136.02.285.037.443.051.713.065 1.669.071 2.516-.211.518-.173.994-.68 1.2-1.272a1.896 1.896 0 0 0-.234-1.734c.058-.118.103-.242.138-.362.077-.27.113-.568.113-.856 0-.29-.036-.586-.113-.857a2.094 2.094 0 0 0-.16-.403c.169-.387.107-.82-.003-1.149a3.162 3.162 0 0 0-.488-.9c.054-.153.076-.313.076-.465a1.86 1.86 0 0 0-.253-.912C13.1.757 12.437.28 11.5.28H8c-.605 0-1.07.08-1.466.217a4.823 4.823 0 0 0-.97.485l-.048.029c-.504.308-.999.61-2.068.723C2.682 1.815 2 2.434 2 3.279v4c0 .851.685 1.433 1.357 1.616.849.232 1.574.787 2.132 1.41.56.626.914 1.28 1.039 1.638.199.575.356 1.54.428 2.591z" />
    ...
    <div class="modal fade" id="leaveGroup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content ">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button type="button" class="btn px-5 " data-bs-toggle="modal" data-bs-target="#group-left"
